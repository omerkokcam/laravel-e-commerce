...
{{--                    <div style="padding-left:250px" class="panel-heading">eBuy Yönetici Sayfası Oturum Aç</div>--}}
{{--                    <div class="panel-body">--}}

{{--                        <img style="padding-left:230px; width:600px ;height:150px ;padding-bottom:20px;" src="{{asset('img/logo.png')}}" >--}}
{{--                            @include('layouts.partials.errors')--}}

{{--                        <form style=" margin-bottom: 200px" class="form-horizontal" role="form" method="POST" action="{{route('yonetici.oturumac')}}">--}}
{{--                            {{csrf_field()}}--}}
